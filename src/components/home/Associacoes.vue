<template>
  <div class="associacoes">
    <div class="content">
      <div class="title">Associações a que pertencemos</div>
      <div class="items">
...
export default {
  ...
  mounted() {
    ...
    var vm = this;
    axios
      .get("https://www.harmonizando.com/data_api/getAssociacoes.php")
      .then(resp => {
        const data = resp.data;
        var its = [];
        map.call(data, function(d) {
          vm.items[0].name = d.associacoes_name;
          vm.items[0].icon_src = d.__images_file;
          its.push({
            name: d.associacoes_name,
            img_src:
